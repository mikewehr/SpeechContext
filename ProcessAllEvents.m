...
% list of master directories 
    ...
    for iMouse = 1:length(datadir)
        ...
        L = (rez.ops.recLength)/rez.ops.fs;
        ...
        savename = fullfile(datadir{iMouse}, strcat('MasterEvents-', mouseID));
        save(savename, 'MasterEvents', 'L', 'sampleRate');
        savename2 = fullfile(datadir{iMouse}, strcat('MasterStimlog-', mouseID));
        save(savename2, 'MasterStimlog');
    end
end